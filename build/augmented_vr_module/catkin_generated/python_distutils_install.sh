...
echo_and_run cd "/home/andrew/viper/src/augmented_vr_module"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/andrew/viper/src/augmented_vr_module/setup.py" \
     \
    build --build-base "/home/andrew/viper/build/augmented_vr_module" \
    install \
    --root="${DESTDIR-/}" \

...
echo_and_run cd "/home/andrew/viper/src/pose_detection_module"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/andrew/viper/src/pose_detection_module/setup.py" \
     \
    build --build-base "/home/andrew/viper/build/pose_detection_module" \
    install \
    --root="${DESTDIR-/}" \

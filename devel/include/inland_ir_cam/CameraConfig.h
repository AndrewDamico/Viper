...
// *********************************************************
//
// File autogenerated for the inland_ir_cam package
// by the dynamic_reconfigure package.
// Please do not edit.
//
// ********************************************************/

#ifndef __inland_ir_cam__CAMERACONFIG_H__
#define __inland_ir_cam__CAMERACONFIG_H__
...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(CameraConfig::AbstractParamDescriptionConstPtr(new CameraConfig::ParamDescription<std::string>("exposure_mode", "str", 0, "Exposure mode", "{'enum': [{'name': 'off', 'type': 'str', 'value': 'off', 'srcline': 21, 'srcfile': '/home/andrew/viper/src/inland_ir_cam/cfg/Camera.cfg', 'description': '', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'auto', 'type': 'str', 'value': 'auto', 'srcline': 22, 'srcfile': '/home/andrew/viper/src/inland_ir_cam/cfg/Camera.cfg', 'description': '', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'night', 'type': 'str', 'value': 'night', 'srcline': 23, 'srcfile': '/home/andrew/viper/src/inland_ir_cam/cfg/Camera.cfg', 'description': '', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'nightpreview', 'type': 'str', 'value': 'nightpreview', 'srcline': 24, 'srcfile': '/home/andrew/viper/src/inland_ir_cam/cfg/Camera.cfg', 'description': '', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'backlight', 'type': 'str', 'value': 'backlight', 'srcline': 25, 'srcfile': '/home/andrew/viper/src/inland_ir_cam/cfg/Camera.cfg', 'description': '', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'spotlight', 'type': 'str', 'value': 'spotlight', 'srcline': 26, 'srcfile': '/home/andrew/viper/src/inland_ir_cam/cfg/Camera.cfg', 'description': '', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'sports', 'type': 'str', 'value': 'sports', 'srcline': 27, 'srcfile': '/home/andrew/viper/src/inland_ir_cam/cfg/Camera.cfg', 'description': '', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'snow', 'type': 'str', 'value': 'snow', 'srcline': 28, 'srcfile': '/home/andrew/viper/src/inland_ir_cam/cfg/Camera.cfg', 'description': '', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'beach', 'type': 'str', 'value': 'beach', 'srcline': 29, 'srcfile': '/home/andrew/viper/src/inland_ir_cam/cfg/Camera.cfg', 'description': '', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'verylong', 'type': 'str', 'value': 'verylong', 'srcline': 30, 'srcfile': '/home/andrew/viper/src/inland_ir_cam/cfg/Camera.cfg', 'description': '', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'fixedfps', 'type': 'str', 'value': 'fixedfps', 'srcline': 31, 'srcfile': '/home/andrew/viper/src/inland_ir_cam/cfg/Camera.cfg', 'description': '', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'antishake', 'type': 'str', 'value': 'antishake', 'srcline': 32, 'srcfile': '/home/andrew/viper/src/inland_ir_cam/cfg/Camera.cfg', 'description': '', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'fireworks', 'type': 'str', 'value': 'fireworks', 'srcline': 33, 'srcfile': '/home/andrew/viper/src/inland_ir_cam/cfg/Camera.cfg', 'description': '', 'ctype': 'std::string', 'cconsttype': 'const char * const'}], 'enum_description': 'Exposure modes'}", &CameraConfig::exposure_mode)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(CameraConfig::AbstractParamDescriptionConstPtr(new CameraConfig::ParamDescription<std::string>("awb_mode", "str", 0, "AWB mode", "{'enum': [{'name': 'awb_off', 'type': 'str', 'value': 'off', 'srcline': 37, 'srcfile': '/home/andrew/viper/src/inland_ir_cam/cfg/Camera.cfg', 'description': '', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'awb_auto', 'type': 'str', 'value': 'auto', 'srcline': 38, 'srcfile': '/home/andrew/viper/src/inland_ir_cam/cfg/Camera.cfg', 'description': '', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'awb_sun', 'type': 'str', 'value': 'sun', 'srcline': 39, 'srcfile': '/home/andrew/viper/src/inland_ir_cam/cfg/Camera.cfg', 'description': '', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'awb_cloud', 'type': 'str', 'value': 'cloud', 'srcline': 40, 'srcfile': '/home/andrew/viper/src/inland_ir_cam/cfg/Camera.cfg', 'description': '', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'awb_shade', 'type': 'str', 'value': 'shade', 'srcline': 41, 'srcfile': '/home/andrew/viper/src/inland_ir_cam/cfg/Camera.cfg', 'description': '', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'awb_tungsten', 'type': 'str', 'value': 'tungsten', 'srcline': 42, 'srcfile': '/home/andrew/viper/src/inland_ir_cam/cfg/Camera.cfg', 'description': '', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'awb_fluorescent', 'type': 'str', 'value': 'fluorescent', 'srcline': 43, 'srcfile': '/home/andrew/viper/src/inland_ir_cam/cfg/Camera.cfg', 'description': '', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'awb_incandescent', 'type': 'str', 'value': 'incandescent', 'srcline': 44, 'srcfile': '/home/andrew/viper/src/inland_ir_cam/cfg/Camera.cfg', 'description': '', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'awb_flash', 'type': 'str', 'value': 'flash', 'srcline': 45, 'srcfile': '/home/andrew/viper/src/inland_ir_cam/cfg/Camera.cfg', 'description': '', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'awb_horizon', 'type': 'str', 'value': 'horizon', 'srcline': 46, 'srcfile': '/home/andrew/viper/src/inland_ir_cam/cfg/Camera.cfg', 'description': '', 'ctype': 'std::string', 'cconsttype': 'const char * const'}], 'enum_description': 'AWB modes'}", &CameraConfig::awb_mode)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(CameraConfig::AbstractParamDescriptionConstPtr(new CameraConfig::ParamDescription<std::string>("awb_mode", "str", 0, "AWB mode", "{'enum': [{'name': 'awb_off', 'type': 'str', 'value': 'off', 'srcline': 37, 'srcfile': '/home/andrew/viper/src/inland_ir_cam/cfg/Camera.cfg', 'description': '', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'awb_auto', 'type': 'str', 'value': 'auto', 'srcline': 38, 'srcfile': '/home/andrew/viper/src/inland_ir_cam/cfg/Camera.cfg', 'description': '', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'awb_sun', 'type': 'str', 'value': 'sun', 'srcline': 39, 'srcfile': '/home/andrew/viper/src/inland_ir_cam/cfg/Camera.cfg', 'description': '', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'awb_cloud', 'type': 'str', 'value': 'cloud', 'srcline': 40, 'srcfile': '/home/andrew/viper/src/inland_ir_cam/cfg/Camera.cfg', 'description': '', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'awb_shade', 'type': 'str', 'value': 'shade', 'srcline': 41, 'srcfile': '/home/andrew/viper/src/inland_ir_cam/cfg/Camera.cfg', 'description': '', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'awb_tungsten', 'type': 'str', 'value': 'tungsten', 'srcline': 42, 'srcfile': '/home/andrew/viper/src/inland_ir_cam/cfg/Camera.cfg', 'description': '', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'awb_fluorescent', 'type': 'str', 'value': 'fluorescent', 'srcline': 43, 'srcfile': '/home/andrew/viper/src/inland_ir_cam/cfg/Camera.cfg', 'description': '', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'awb_incandescent', 'type': 'str', 'value': 'incandescent', 'srcline': 44, 'srcfile': '/home/andrew/viper/src/inland_ir_cam/cfg/Camera.cfg', 'description': '', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'awb_flash', 'type': 'str', 'value': 'flash', 'srcline': 45, 'srcfile': '/home/andrew/viper/src/inland_ir_cam/cfg/Camera.cfg', 'description': '', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'awb_horizon', 'type': 'str', 'value': 'horizon', 'srcline': 46, 'srcfile': '/home/andrew/viper/src/inland_ir_cam/cfg/Camera.cfg', 'description': '', 'ctype': 'std::string', 'cconsttype': 'const char * const'}], 'enum_description': 'AWB modes'}", &CameraConfig::awb_mode)));
...
//#line 21 "/home/andrew/viper/src/inland_ir_cam/cfg/Camera.cfg"
      const char * const Camera_off = "off";
//#line 22 "/home/andrew/viper/src/inland_ir_cam/cfg/Camera.cfg"
      const char * const Camera_auto = "auto";
//#line 23 "/home/andrew/viper/src/inland_ir_cam/cfg/Camera.cfg"
      const char * const Camera_night = "night";
//#line 24 "/home/andrew/viper/src/inland_ir_cam/cfg/Camera.cfg"
      const char * const Camera_nightpreview = "nightpreview";
//#line 25 "/home/andrew/viper/src/inland_ir_cam/cfg/Camera.cfg"
      const char * const Camera_backlight = "backlight";
//#line 26 "/home/andrew/viper/src/inland_ir_cam/cfg/Camera.cfg"
      const char * const Camera_spotlight = "spotlight";
//#line 27 "/home/andrew/viper/src/inland_ir_cam/cfg/Camera.cfg"
      const char * const Camera_sports = "sports";
//#line 28 "/home/andrew/viper/src/inland_ir_cam/cfg/Camera.cfg"
      const char * const Camera_snow = "snow";
//#line 29 "/home/andrew/viper/src/inland_ir_cam/cfg/Camera.cfg"
      const char * const Camera_beach = "beach";
//#line 30 "/home/andrew/viper/src/inland_ir_cam/cfg/Camera.cfg"
      const char * const Camera_verylong = "verylong";
//#line 31 "/home/andrew/viper/src/inland_ir_cam/cfg/Camera.cfg"
      const char * const Camera_fixedfps = "fixedfps";
//#line 32 "/home/andrew/viper/src/inland_ir_cam/cfg/Camera.cfg"
      const char * const Camera_antishake = "antishake";
//#line 33 "/home/andrew/viper/src/inland_ir_cam/cfg/Camera.cfg"
      const char * const Camera_fireworks = "fireworks";
//#line 37 "/home/andrew/viper/src/inland_ir_cam/cfg/Camera.cfg"
      const char * const Camera_awb_off = "off";
//#line 38 "/home/andrew/viper/src/inland_ir_cam/cfg/Camera.cfg"
      const char * const Camera_awb_auto = "auto";
//#line 39 "/home/andrew/viper/src/inland_ir_cam/cfg/Camera.cfg"
      const char * const Camera_awb_sun = "sun";
//#line 40 "/home/andrew/viper/src/inland_ir_cam/cfg/Camera.cfg"
      const char * const Camera_awb_cloud = "cloud";
//#line 41 "/home/andrew/viper/src/inland_ir_cam/cfg/Camera.cfg"
      const char * const Camera_awb_shade = "shade";
//#line 42 "/home/andrew/viper/src/inland_ir_cam/cfg/Camera.cfg"
      const char * const Camera_awb_tungsten = "tungsten";
//#line 43 "/home/andrew/viper/src/inland_ir_cam/cfg/Camera.cfg"
      const char * const Camera_awb_fluorescent = "fluorescent";
//#line 44 "/home/andrew/viper/src/inland_ir_cam/cfg/Camera.cfg"
      const char * const Camera_awb_incandescent = "incandescent";
//#line 45 "/home/andrew/viper/src/inland_ir_cam/cfg/Camera.cfg"
      const char * const Camera_awb_flash = "flash";
//#line 46 "/home/andrew/viper/src/inland_ir_cam/cfg/Camera.cfg"

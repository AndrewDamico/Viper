...
(cl:in-package inland_ir_cam-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <MotionVectors>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MotionVectors)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name inland_ir_cam-msg:<MotionVectors> is deprecated: use inland_ir_cam-msg:MotionVectors instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <MotionVectors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader inland_ir_cam-msg:header-val is deprecated.  Use inland_ir_cam-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'mbx-val :lambda-list '(m))
(cl:defmethod mbx-val ((m <MotionVectors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader inland_ir_cam-msg:mbx-val is deprecated.  Use inland_ir_cam-msg:mbx instead.")
  (mbx m))

(cl:ensure-generic-function 'mby-val :lambda-list '(m))
(cl:defmethod mby-val ((m <MotionVectors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader inland_ir_cam-msg:mby-val is deprecated.  Use inland_ir_cam-msg:mby instead.")
  (mby m))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <MotionVectors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader inland_ir_cam-msg:x-val is deprecated.  Use inland_ir_cam-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <MotionVectors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader inland_ir_cam-msg:y-val is deprecated.  Use inland_ir_cam-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'sad-val :lambda-list '(m))
(cl:defmethod sad-val ((m <MotionVectors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader inland_ir_cam-msg:sad-val is deprecated.  Use inland_ir_cam-msg:sad instead.")
  (sad m))
